...
The `number of followers` of users in Sri Lanka on `2025/6/16 6:59 AM UTC`. This list contains users from `Sri Lanka` and cities `Colombo` `Kandy` `Gampaha` `Galle` `Jaffna` `Matara`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/Codersauruse">
				<img src="https://avatars.githubusercontent.com/u/104962511?s=72&v=4" width="24" alt="Avatar of Codersauruse"> Codersauruse
			</a><br/>
			Shehan Jayaranga
		</td>
		<td>@tech-venturas  </td>
