...
The `number of followers` of users in Sri Lanka on `2025/7/5 6:57 PM UTC`. This list contains users from `Sri Lanka` and cities `Colombo` `Kandy` `Gampaha` `Galle` `Jaffna` `Matara`.

There are `1 countries` and `6 cities` can be found [here](https://github.com/DARKDRAGON-LK/top-github-users-in-sri-lanka).

There are `934 users`  in Sri Lanka. You need at least `19 followers` to be on this list.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/KavinduSenesh">
				<img src="https://avatars.githubusercontent.com/u/140303230?s=72&u=f70a8ad3ca11b9d7f30837bd545e3e4137c4dca6&v=4" width="24" alt="Avatar of KavinduSenesh"> KavinduSenesh
			</a><br/>
			Kavindu Senesh
		</td>
		<td>No Company</td>
